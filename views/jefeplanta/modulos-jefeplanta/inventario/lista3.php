...
<div class="container">
  ...
  <div class="wizard-panel">
    ...
    <div id="contenido1" class="wizard-content active">
      ...
      <form method="GET" action="/sistema-produccion/public/index.php" style="display:inline-block;">
        ...
        <input type="hidden" name="bpa" value="3">
        <label for="fecha_semana_3">Fecha base:</label>
        <input type="date" id="fecha_semana_3" name="fecha_semana" value="<?php echo date('Y-m-d'); ?>" required>
    ...
    <div id="contenido2" class="wizard-content">
      ...
      <form method="GET" action="/sistema-produccion/public/index.php" style="display:inline-block;">
        ...
        <input type="hidden" name="action" value="exportBPAExcel">
        <input type="hidden" name="bpa" value="3">
        <label for="fecha_mes_3">Mes:</label>
        <input type="month" id="fecha_mes_3" name="fecha_mes" value="<?php echo date('Y-m'); ?>" required>
    ...
    <div id="contenido3" class="wizard-content">
      ...
      <form method="GET" action="/sistema-produccion/public/index.php" style="display:inline-block;">
        ...
        <input type="hidden" name="action" value="exportBPAExcel">
        <input type="hidden" name="bpa" value="3">
        <label for="fecha_anio_3">Año:</label>
        <input type="number" id="fecha_anio_3" name="fecha_anio" value="<?php echo date('Y'); ?>" min="2000" max="2100" required>
  ...
  <!-- Tabla de medicamentos (sin cambios en lógica) -->
  <table>
    <thead>
      <tr>
        <th>#</th>
