...
<title>Listado Diario — Control de Alimento</title>
<style>
  *{box-sizing:border-box;font-family:"Poppins","Segoe UI",sans-serif;}
  ...
  .circle{
    ...
    line-height:50px;
    border-radius:50%;
    background:#ffb366; /* naranja claro */
    color:#fff;
    font-weight:700;
    margin:auto;
    font-size:1.2rem;
...
<div class="container">
  <h1>📅 Listado-Control de Alimento en Almacén</h1>

  <!-- Panel completo con Wizard dentro -->
  <div class="wizard-panel">
    ...
    <div id="contenido1" class="wizard-content active">
      ...
      <form method="GET" action="/sistema-produccion/public/index.php" style="display:inline-block;">
        ...
        <input type="hidden" name="bpa" value="1">
        <label for="fecha_semana_1">Fecha base:</label>
        <input type="date" id="fecha_semana_1" name="fecha_semana" value="<?php echo date('Y-m-d'); ?>" required>
    ...
    <div id="contenido2" class="wizard-content">
      ...
      <form method="GET" action="/sistema-produccion/public/index.php" style="display:inline-block;">
        ...
        <input type="hidden" name="action" value="exportBPAExcel">
        <input type="hidden" name="bpa" value="1">
        <label for="fecha_mes_1">Mes:</label>
        <input type="month" id="fecha_mes_1" name="fecha_mes" value="<?php echo date('Y-m'); ?>" required>
    ...
    <div id="contenido3" class="wizard-content">
      ...
      <form method="GET" action="/sistema-produccion/public/index.php" style="display:inline-block;">
        ...
        <input type="hidden" name="action" value="exportBPAExcel">
        <input type="hidden" name="bpa" value="1">
        <label for="fecha_anio_1">Año:</label>
        <input type="number" id="fecha_anio_1" name="fecha_anio" value="<?php echo date('Y'); ?>" min="2000" max="2100" required>
