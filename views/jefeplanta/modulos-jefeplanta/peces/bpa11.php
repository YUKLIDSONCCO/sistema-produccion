...
<body>
  ...
  <script>
    ...
    function verListado(){
      // Recolectar filas como arrays de valores por simplicidad
      const filas = Array.from(document.querySelectorAll('#tablaVenta tbody tr')).map(tr => {
      ...
      localStorage.setItem('bpa11_registros', JSON.stringify(registros));

      window.location.href = 'index.php?controller=Peces&action=bpa11Listado';
    }
